...
//            model.addAttribute("locationList", locationService.getLocationList());
    ...
    @PostMapping("/update")
    public String updateSquirrelRanking(Model model, Squirrel squirrel) {
        Squirrel squ = squirrelService.getSquirrel(squirrel.getId());
        squ.setRanking(squirrel.getRanking());

        squirrelService.updateSquirrelRanking(squ);
...
//        model.addAttribute("locationList", locationService.getLocationList());
    ...
    @RequestMapping("/rank")
    public String showRankingForm(Model model, @RequestParam("id") int squirrelId) {
        model.addAttribute("pageTitle", "Rank A Squirrel");
//        model.addAttribute("squirrel", squirrelService.getSquirrel(squirrelId));
