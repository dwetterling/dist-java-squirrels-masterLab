insert into squirrel(squirrel_id, species, ranking, common_name, habitat, image_file_name)
values(1, 'Ratufa macroura', 0, 'Grizzled giant squirrel', 'Sri Lanka', 'ggs.jpg');

insert into squirrel(squirrel_id, species,ranking, common_name, habitat, image_file_name)
values (2, 'Petaurista philippensis', 0, 'Indian giant flying squirrel', 'India and China', 'igfs.jpg');

insert into squirrel(squirrel_id, species,ranking, common_name, habitat, image_file_name)
values (3, 'Pteromys momonga', 0, 'Japanese dwarf flying squirrel', 'Japan', 'jdfs.jpg');

insert into squirrel(squirrel_id, species, ranking, common_name, habitat, image_file_name)
values (4, 'Petaurista petaurista', 0, 'Red giant flying squirrel', 'Southeast Asia', 'grfs.jpg');

insert into squirrel(squirrel_id, species, ranking, common_name, habitat, image_file_name)
values (5, 'Callosciurus prevostii', 0, 'Prevost''s squirrel', 'Thai-Malay Peninsula', 'ps.jpg');

insert into squirrel(squirrel_id, species, ranking, common_name, habitat, image_file_name)
values (6, 'Ratufa indica', 0, 'Malabar giant squirrel', 'India', 'mgs.jpg');
